import sys
from tkinter import Button, Frame, Listbox, Scrollbar, Tk, messagebox
from tkinter import filedialog as fd
from tkinter.constants import DISABLED, END, EXTENDED, LEFT, NORMAL, VERTICAL
...
def listbox_init():
    listbox.insert(END, "No files selected")
...
def save_pdf():
    ...
    out_fname = fd.asksaveasfilename(
...
delete_button = Button(
    controls_frame, text="Delete selected images", command=delete_files
)
